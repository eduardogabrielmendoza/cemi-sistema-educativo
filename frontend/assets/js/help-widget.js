...
(function() {
  ...
  const widgetStyles = `
    ...
    .cemi-help-btn { width: 56px; height: 56px; background: linear-gradient(135deg, #1e3a5f 0%, #2563eb 100%); border: none; border-radius: 50%; cursor: pointer; display: flex; align-items: center; justify-content: center; box-shadow: 0 4px 20px rgba(30, 58, 95, 0.4); transition: all 0.3s cubic-bezier(0.4, 0, 0.2, 1); }
    .cemi-help-btn:hover { transform: scale(1.1); box-shadow: 0 8px 30px rgba(30, 58, 95, 0.5); }
    ...
    .cemi-help-dropdown-header { padding: 20px; background: linear-gradient(135deg, #1e3a5f 0%, #2563eb 100%); color: white; }
    ...
    .cemi-help-dropdown-item:hover { background: #f1f5f9; color: #1e3a5f; }
    .cemi-help-dropdown-item svg { width: 20px; height: 20px; color: #64748b; transition: color 0.2s ease; }
    .cemi-help-dropdown-item:hover svg { color: #2563eb; }
    ...
    .cemi-help-panel-header { padding: 20px; background: linear-gradient(135deg, #1e3a5f 0%, #2563eb 100%); color: white; display: flex; justify-content: space-between; align-items: center; flex-shrink: 0; }
    ...
    .cemi-help-panel-search-input:focus { outline: none; border-color: #2563eb; box-shadow: 0 0 0 3px rgba(37, 99, 235, 0.1); background-color: white; }
    ...
    .cemi-help-article-icon { width: 36px; height: 36px; background: #dbeafe; border-radius: 8px; display: flex; align-items: center; justify-content: center; flex-shrink: 0; }
    .cemi-help-article-icon svg { width: 18px; height: 18px; color: #2563eb; }
    .cemi-help-article-content h5 { font-size: 14px; font-weight: 500; color: #1e3a5f; margin: 0 0 4px 0; }
    .cemi-help-article-content p { font-size: 12px; color: #64748b; margin: 0; line-height: 1.4; }
    .cemi-help-link-btn { display: flex; align-items: center; justify-content: center; gap: 8px; width: 100%; padding: 12px; background: #f1f5f9; border: none; border-radius: 10px; color: #2563eb; font-size: 14px; font-weight: 500; cursor: pointer; transition: all 0.2s ease; text-decoration: none; }
    .cemi-help-link-btn:hover { background: #dbeafe; }
    ...
    .cemi-help-panel-footer a:hover { color: #2563eb; }
    ...
    .cemi-feedback-header h3 { font-size: 18px; font-weight: 600; color: #1e3a5f; margin: 0; display: flex; align-items: center; gap: 12px; }
    .cemi-feedback-header h3 svg { width: 24px; height: 24px; color: #2563eb; }
    ...
    .cemi-feedback-group select:focus, .cemi-feedback-group textarea:focus { outline: none; border-color: #2563eb; box-shadow: 0 0 0 3px rgba(37, 99, 235, 0.1); }
    ...
    .cemi-feedback-btn.primary { background: linear-gradient(135deg, #1e3a5f, #2563eb); color: white; }
    .cemi-feedback-btn.primary:hover { transform: translateY(-2px); box-shadow: 0 8px 20px rgba(37, 99, 235, 0.3); }
