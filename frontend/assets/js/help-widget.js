...
(function() {
  ...
  const widgetStyles = `
    ...
    .cemi-help-btn { width: 56px; height: 56px; background: linear-gradient(135deg, #547194 0%, #667eea 100%); border: none; border-radius: 50%; cursor: pointer; display: flex; align-items: center; justify-content: center; box-shadow: 0 4px 20px rgba(84, 113, 148, 0.4); transition: all 0.3s cubic-bezier(0.4, 0, 0.2, 1); }
    ...
    .cemi-help-dropdown-header { padding: 20px; background: linear-gradient(135deg, #547194 0%, #667eea 100%); color: white; }
    ...
    .cemi-help-dropdown-item:hover svg { color: #667eea; }
    ...
    .cemi-help-panel-header { padding: 20px; background: linear-gradient(135deg, #547194 0%, #667eea 100%); color: white; display: flex; justify-content: space-between; align-items: center; flex-shrink: 0; }
    ...
    .cemi-help-panel-search-input:focus { outline: none; border-color: #667eea; box-shadow: 0 0 0 3px rgba(102, 126, 234, 0.1); background-color: white; }
    ...
    .cemi-help-article-icon { width: 36px; height: 36px; background: rgba(102, 126, 234, 0.15); border-radius: 8px; display: flex; align-items: center; justify-content: center; flex-shrink: 0; }
    .cemi-help-article-icon svg { width: 18px; height: 18px; color: #667eea; }
    ...
    .cemi-help-link-btn { display: flex; align-items: center; justify-content: center; gap: 8px; width: 100%; padding: 12px; background: #f1f5f9; border: none; border-radius: 10px; color: #667eea; font-size: 14px; font-weight: 500; cursor: pointer; transition: all 0.2s ease; text-decoration: none; }
    .cemi-help-link-btn:hover { background: rgba(102, 126, 234, 0.15); }
    ...
    .cemi-help-panel-footer a:hover { color: #667eea; }
    ...
    .cemi-feedback-header h3 { font-size: 18px; font-weight: 600; color: #547194; margin: 0; display: flex; align-items: center; gap: 12px; }
    .cemi-feedback-header h3 svg { width: 24px; height: 24px; color: #667eea; }
    ...
    .cemi-feedback-group select:focus, .cemi-feedback-group textarea:focus { outline: none; border-color: #667eea; box-shadow: 0 0 0 3px rgba(102, 126, 234, 0.1); }
    ...
    .cemi-feedback-btn.primary { background: linear-gradient(135deg, #547194, #667eea); color: white; }
    .cemi-feedback-btn.primary:hover { transform: translateY(-2px); box-shadow: 0 8px 20px rgba(102, 126, 234, 0.3); }
