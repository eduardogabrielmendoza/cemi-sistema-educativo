...
(function() {
  ...
  const widgetStyles = `
    ...
    .cemi-help-btn { width: 56px; height: 56px; background: #4a5259; border: none; border-radius: 50%; cursor: pointer; display: flex; align-items: center; justify-content: center; box-shadow: 0 4px 20px rgba(84, 113, 148, 0.4); transition: all 0.3s cubic-bezier(0.4, 0, 0.2, 1); }
    ...
    .cemi-help-dropdown-header { padding: 20px; background: #4a5259; color: white; }
    ...
    .cemi-help-dropdown-item:hover svg { color: #4a5259; }
    ...
    .cemi-help-panel-header { padding: 20px; background: #4a5259; color: white; display: flex; justify-content: space-between; align-items: center; flex-shrink: 0; }
    ...
    .cemi-help-panel-search-input:focus { outline: none; border-color: #4a5259; box-shadow: 0 0 0 3px rgba(74, 82, 89, 0.1); background-color: white; }
    ...
    .cemi-help-article-icon { width: 36px; height: 36px; background: rgba(74, 82, 89, 0.08); border-radius: 8px; display: flex; align-items: center; justify-content: center; flex-shrink: 0; }
    .cemi-help-article-icon svg { width: 18px; height: 18px; color: #4a5259; }
    ...
    .cemi-help-link-btn { display: flex; align-items: center; justify-content: center; gap: 8px; width: 100%; padding: 12px; background: #f1f5f9; border: none; border-radius: 10px; color: #4a5259; font-size: 14px; font-weight: 500; cursor: pointer; transition: all 0.2s ease; text-decoration: none; }
    .cemi-help-link-btn:hover { background: rgba(74, 82, 89, 0.08); }
    ...
    .cemi-help-panel-footer a:hover { color: #4a5259; }
    ...
    .cemi-feedback-header h3 svg { width: 24px; height: 24px; color: #4a5259; }
    ...
    .cemi-feedback-group select:focus, .cemi-feedback-group textarea:focus { outline: none; border-color: #4a5259; box-shadow: 0 0 0 3px rgba(74, 82, 89, 0.1); }
    ...
    .cemi-feedback-btn.primary { background: #4a5259; color: white; }
    .cemi-feedback-btn.primary:hover { transform: translateY(-2px); box-shadow: 0 8px 20px rgba(74, 82, 89, 0.3); }
