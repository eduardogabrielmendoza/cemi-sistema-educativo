...
(function() {
  ...
  const widgetStyles = `
    ...
    .cemi-help-btn { width: 56px; height: 56px; background: linear-gradient(135deg, #0A2540 0%, #1A3A5C 100%); border: none; border-radius: 50%; cursor: pointer; display: flex; align-items: center; justify-content: center; box-shadow: 0 4px 20px rgba(84, 113, 148, 0.4); transition: all 0.3s cubic-bezier(0.4, 0, 0.2, 1); }
    ...
    .cemi-help-dropdown-header { padding: 20px; background: linear-gradient(135deg, #0A2540 0%, #1A3A5C 100%); color: white; }
    ...
    .cemi-help-dropdown-item:hover { background: #f1f5f9; color: #1A3A5C; }
    .cemi-help-dropdown-item svg { width: 20px; height: 20px; color: #64748b; transition: color 0.2s ease; }
    .cemi-help-dropdown-item:hover svg { color: #1A3A5C; }
    ...
    .cemi-help-panel-header { padding: 20px; background: linear-gradient(135deg, #0A2540 0%, #1A3A5C 100%); color: white; display: flex; justify-content: space-between; align-items: center; flex-shrink: 0; }
    ...
    .cemi-help-panel-search-input:focus { outline: none; border-color: #1A3A5C; box-shadow: 0 0 0 3px rgba(84, 113, 148, 0.15); background-color: white; }
    ...
    .cemi-help-article-icon svg { width: 18px; height: 18px; color: #1A3A5C; }
    .cemi-help-article-content h5 { font-size: 14px; font-weight: 500; color: #1A3A5C; margin: 0 0 4px 0; }
    .cemi-help-article-content p { font-size: 12px; color: #64748b; margin: 0; line-height: 1.4; }
    .cemi-help-link-btn { display: flex; align-items: center; justify-content: center; gap: 8px; width: 100%; padding: 12px; background: #f1f5f9; border: none; border-radius: 10px; color: #1A3A5C; font-size: 14px; font-weight: 500; cursor: pointer; transition: all 0.2s ease; text-decoration: none; }
    ...
    .cemi-help-panel-footer a:hover { color: #1A3A5C; }
    ...
    .cemi-feedback-header h3 svg { width: 24px; height: 24px; color: #1A3A5C; }
    ...
    .cemi-feedback-group select:focus, .cemi-feedback-group textarea:focus { outline: none; border-color: #1A3A5C; box-shadow: 0 0 0 3px rgba(84, 113, 148, 0.15); }
    ...
    .cemi-feedback-btn.primary { background: linear-gradient(135deg, #0A2540, #1A3A5C); color: white; }
