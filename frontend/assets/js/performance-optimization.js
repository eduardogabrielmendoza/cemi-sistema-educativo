 ...
 * Lazy loading y optimizaciones para mejorar la velocidad en móviles
 */
...
// Throttle function para scroll y resize
  ...
  if ('connection' in navigator) {
    ...
    if (connection) {
      ...
      if (slowConnection) {
        ...
        // Deshabilitar imágenes de fondo decorativas
...
// Optimizar rendimiento de formularios grandes
function optimizeLargeForms() {
  ...
  forms.forEach(form => {
    ...
    if (inputs.length > 10) {
      // Agregar debounce a validaciones
