...
async function submitIncident() {
  ...
  try {
    const response = await fetchWithAuth('/api/status/incident', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
      body: JSON.stringify({
        title,
...
async function resolveIncident(id) {
  ...
  try {
    const response = await fetchWithAuth(`/api/status/incident/${id}`, {
      method: 'PUT',
      headers: { 'Content-Type': 'application/json' },
...
async function deleteIncident(id) {
  ...
  try {
    const response = await fetchWithAuth(`/api/status/incident/${id}`, { method: 'DELETE' });
...
async function generateDashboardHome() {
  try {
    const [statsRes, registrosRes, pagosRes] = await Promise.all([
      fetchWithAuth(`${API_URL}/stats/general`),
      fetchWithAuth(`${API_URL}/stats/ultimos-registros`),
      fetchWithAuth(`${API_URL}/stats/ultimos-pagos`)
    ]);
...
async function cargarAlumnosInscritos(idCurso) {
  ...
  try {
    const res = await fetchWithAuth(`${API_URL}/inscripciones/curso/${idCurso}`);
...
async function cargarAlumnosDisponibles(idCurso) {
  ...
  try {
    const [resAlumnos, resInscritos] = await Promise.all([
      fetchWithAuth(`${API_URL}/alumnos`),
      fetchWithAuth(`${API_URL}/inscripciones/curso/${idCurso}`)
    ]);
    ...
    document.getElementById('btnConfirmInscribir').onclick = async () => {
      ...
      try {
        const resp = await fetchWithAuth(`${API_URL}/inscripciones`, {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
...
async function darDeBajaAlumno(idCurso, idAlumno, nombreAlumno) {
  ...
  try {
    const resp = await fetchWithAuth(`${API_URL}/inscripciones/${idCurso}/${idAlumno}`, {
      method: 'DELETE'
    });
...
async function openCursoPanel(idCurso) {
  ...
  try {
    const [resCurso, resInscritos] = await Promise.all([
      fetchWithAuth(`${API_URL}/cursos/${idCurso}`),
      fetchWithAuth(`${API_URL}/inscripciones/curso/${idCurso}`)
    ]);
...
async function openEditarCursoModal(curso) {
  ...
  try {
    const resCursoCompleto = await fetchWithAuth(`${API_URL}/cursos/${curso.id_curso}`);
    const cursoCompleto = await resCursoCompleto.json();

    const [resIdiomas, resProfesores] = await Promise.all([
      fetchWithAuth(`${API_URL}/idiomas`),
      fetchWithAuth(`${API_URL}/profesores`)
    ]);
    ...
    document.getElementById('formEditarCurso').onsubmit = async (e) => {
      ...
      try {
        const resp = await fetchWithAuth(`${API_URL}/cursos/${curso.id_curso}`, {
          method: 'PUT',
          headers: { 'Content-Type': 'application/json' },
...
async function initProfesorDashboard() {
  ...
  const sections = {
    btnCursos: async () => {
      loader.classList.remove("hidden");
      try {
        const res = await fetchWithAuth(`${API_URL}/cursos?id_profesor=${idProfesor}`);
        const data = await res.json();
        loader.classList.add("hidden");
    ...
    btnCalificaciones: async () => {
      ...
      mainContent.classList.remove("active");
      try {
        const resCursos = await fetchWithAuth(`${API_URL}/cursos?id_profesor=${idProfesor}`);
        ...
        document.getElementById('selectCurso').addEventListener('change', async (e) => {
          ...
          try {
            const res = await fetchWithAuth(`${API_URL}/calificaciones/curso/${cursoId}`);
...
async function verMisInscripciones() {
  ...
  try {
    const res = await fetchWithAuth(`${API_URL}/inscripciones`);
    const data = await res.json();
    table.innerHTML = `
...
async function openAlumnoPanel(idAlumno) {
  ...
  try {
    const resAlumno = await fetchWithAuth(`${API_URL}/alumnos/${idAlumno}`);
...
async function openProfesorPanel(idProfesor) {
  ...
  try {
    const resProfesor = await fetchWithAuth(`${API_URL}/profesores/${idProfesor}`);
...
async function initIdiomasMultiSelect(mode = 'edit', selectedIds = []) {
  ...
  try {
    const resp = await fetchWithAuth(`${API_URL}/idiomas`);
...
function ensureEditarProfesorModal() {
  ...
  document.getElementById('formEditarProfesor').addEventListener('submit', async (e) => {
    ...
    try {
      const resp = await fetchWithAuth(`${API_URL}/profesores/${idProfesor}`, {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json' },
...
async function abrirModalCredencialesProfesor(idProfesor) {
  try {
    ...
    try {
      const respUsuario = await fetchWithAuth(`${API_URL}/auth/usuario-classroom/${profesor.id_persona}`);
      if (respUsuario.ok) {
    ...
    if (result.isConfirmed && result.value) {
      ...
      try {
        ...
        const response = await fetchWithAuth(`${API_URL}/auth/admin-cambiar-password-classroom`, {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
...
async function cambiarEstadoProfesor(idProfesor, estadoActual) {
  ...
  try {
    const resp = await fetchWithAuth(`${API_URL}/profesores/${idProfesor}/estado`, {
      method: 'PATCH',
      headers: { 'Content-Type': 'application/json' },
...
async function cambiarPasswordProfesorDashboard(idProfesor) {
  ...
  try {
    const resp = await fetchWithAuth(`${API_URL}/profesores/${idProfesor}/cambiar-password-dashboard`, {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
...
async function cambiarPasswordProfesorClassroom(idProfesor) {
  ...
  try {
    const resp = await fetchWithAuth(`${API_URL}/auth/admin-cambiar-password-classroom`, {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
      body: JSON.stringify({ 
...
async function loadPagosData(queryParams = '') {
  try {
    ...
    const resp = await fetchWithAuth(`${API_URL}/pagos${queryParams}`);
...
async function openPagoPanel(idAlumno) {
  ...
  try {
    const [alumnoResp, pagosResp] = await Promise.all([
      fetchWithAuth(`${API_URL}/alumnos/${idAlumno}`),
      fetchWithAuth(`${API_URL}/pagos/alumno/${idAlumno}/historial`)
    ]);
...
async function confirmarPago(idPago, nombreAlumno, concepto) {
  ...
  try {
    const resp = await fetchWithAuth(`${API_URL}/pagos/${idPago}/confirmar`, {
      method: 'PUT'
    });
...
async function anularPago(idPago, nombreAlumno, concepto) {
  ...
  try {
    const resp = await fetchWithAuth(`${API_URL}/pagos/${idPago}/anular`, {
      method: 'PUT'
    });
...
async function archivarPago(idPago, nombreAlumno, concepto) {
  ...
  try {
    const resp = await fetchWithAuth(`${API_URL}/pagos/${idPago}/archivar`, {
      method: 'PUT'
    });
...
async function desarchivarPago(idPago, nombreAlumno, concepto) {
  ...
  try {
    const resp = await fetchWithAuth(`${API_URL}/pagos/${idPago}/desarchivar`, {
      method: 'PUT'
    });
...
async function eliminarPagoDefinitivamente(idPago, nombreAlumno, concepto) {
  ...
  try {
    ...
    const resp = await fetchWithAuth(`${API_URL}/pagos/${idPago}`, {
      method: 'DELETE'
    });
...
async function openRegistrarPagoModal() {
  try {
    const responseInscripciones = await fetchWithAuth(`${API_URL}/inscripciones`);
      ...
      didOpen: () => {
        ...
        alumnoSelect.addEventListener('change', async (e) => {
          ...
          try {
            ...
            const response = await fetchWithAuth(`${API_URL}/inscripciones/alumno/${idAlumno}`);
            ...
            const responsePagos = await fetchWithAuth(`${API_URL}/pagos/alumno/${idAlumno}`);
        ...
        cursoSelect.addEventListener('change', async (e) => {
          ...
          try {
            const respCuotas = await fetchWithAuth(`${API_URL}/cursos/${idCurso}/cuotas`);
    ...
    if (formValues) {
      try {
        ...
        const response = await fetchWithAuth(`${API_URL}/pagos/realizar`, {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
...
async function openNuevaAulaModal() {
  ...
  if (formValues) {
    try {
      const res = await fetchWithAuth(`${API_URL}/aulas`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
...
async function editarAula(id, nombre, capacidad) {
  ...
  if (formValues) {
    try {
      const res = await fetchWithAuth(`${API_URL}/aulas/${id}`, {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
          nombre_aula: formValues.nombre,
...
async function eliminarAula(id, nombre) {
  ...
  if (result.isConfirmed) {
    try {
      const res = await fetchWithAuth(`${API_URL}/aulas/${id}`, { method: 'DELETE' });
      const data = await res.json();
...
async function openNuevoIdiomaModal() {
  ...
  if (nombre) {
    try {
      const res = await fetchWithAuth(`${API_URL}/idiomas`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
...
async function editarIdioma(id, nombreActual) {
  ...
  if (nombre) {
    try {
      const res = await fetchWithAuth(`${API_URL}/idiomas/${id}`, {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({ nombre_idioma: nombre })
      });
...
async function eliminarIdioma(id, nombre) {
  ...
  if (result.isConfirmed) {
    try {
      const res = await fetchWithAuth(`${API_URL}/idiomas/${id}`, { method: 'DELETE' });
      const data = await res.json();
...
async function eliminarInscripcion(id, alumno, curso) {
  ...
  if (result.isConfirmed) {
    try {
      const res = await fetchWithAuth(`${API_URL}/inscripciones/${id}`, { method: 'DELETE' });
      const data = await res.json();
...
async function openNuevoAlumnoModal() {
  ...
  if (formValues) {
    try {
      const res = await fetchWithAuth(`${API_URL}/alumnos`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify(formValues)
      });
...
async function crearCredencialesAlumno(idAlumno, nombreCompleto) {
  ...
  if (credenciales) {
    try {
      const res = await fetchWithAuth(`${API_URL}/alumnos/${idAlumno}/credenciales`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
...
async function editarAlumno(id) {
  try {
    const res = await fetchWithAuth(`${API_URL}/alumnos/${id}`);
    ...
    if (formValues) {
      const updateRes = await fetchWithAuth(`${API_URL}/alumnos/${id}`, {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify(formValues)
      });
...
async function abrirModalCredencialesAlumno(idAlumno) {
  try {
    const resp = await fetchWithAuth(`${API_URL}/alumnos/${idAlumno}`);
    ...
    let tienePassword = false;
    try {
      const respUsuario = await fetchWithAuth(`${API_URL}/auth/usuario-classroom/${alumno.id_persona}`);
      if (respUsuario.ok) {
        const usuario = await respUsuario.json();
        usuarioActual = usuario.username || '';
        passwordActual = usuario.password_plain || '';
...
async function eliminarAlumno(id, nombre) {
  ...
  if (result.isConfirmed) {
    try {
      const res = await fetchWithAuth(`${API_URL}/alumnos/${id}`, { method: 'DELETE' });
      const data = await res.json();
...
async function cambiarPasswordAlumnoDashboard(idAlumno) {
  ...
  if (formValues) {
    try {
      const res = await fetchWithAuth(`${API_URL}/alumnos/${idAlumno}/cambiar-password-dashboard`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify(formValues)
      });
...
async function cambiarPasswordAlumnoClassroom(idAlumno) {
  ...
  if (formValues) {
    try {
      const alumnoRes = await fetchWithAuth(`${API_URL}/alumnos/${idAlumno}`);
      const alumno = await alumnoRes.json();
      
      const res = await fetchWithAuth(`${API_URL}/auth/admin-cambiar-password-classroom`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
          id_persona: alumno.id_persona,
...
async function openNuevoProfesorModal() {
  ...
  if (formValues) {
    try {
      ...
      const res = await fetchWithAuth(`${API_URL}/profesores`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify(formValues)
      });
...
async function crearCredencialesProfesor(idProfesor, nombreCompleto) {
  ...
  if (credenciales) {
    try {
      const res = await fetchWithAuth(`${API_URL}/profesores/${idProfesor}/credenciales`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify(credenciales)
      });
...
async function editarProfesor(id) {
  try {
    const res = await fetchWithAuth(`${API_URL}/profesores/${id}`);
    const profesor = await res.json();
    
    const idiomasRes = await fetchWithAuth(`${API_URL}/idiomas`);
    ...
    if (formValues) {
      const updateRes = await fetchWithAuth(`${API_URL}/profesores/${id}`, {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify(formValues)
      });
...
async function eliminarProfesor(id, nombre) {
  ...
  if (result.isConfirmed) {
    try {
      ...
      const res = await fetchWithAuth(`${API_URL}/profesores/${id}`, { method: 'DELETE' });
      console.log('Respuesta del servidor:', res.status, res.statusText);
      const data = await res.json();
      console.log('Datos recibidos:', data);
...
async function openNuevoAdministradorModal() {
  ...
  if (formValues) {
    try {
      const res = await fetchWithAuth(`${API_URL}/administradores`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify(formValues)
      });
...
async function editarAdministrador(id) {
  try {
    const res = await fetchWithAuth(`${API_URL}/administradores/${id}`);
    ...
    if (formValues) {
      const updateRes = await fetchWithAuth(`${API_URL}/administradores/${id}`, {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify(formValues)
      });
...
async function abrirModalCredencialesAdministrador(idAdmin) {
  try {
    const response = await fetchWithAuth(`${API_URL}/administradores/${idAdmin}`);
    if (!response.ok) throw new Error('Error al cargar datos del administrador');
    const admin = await response.json();

    let passwordActual = '';
    try {
      const respUsuario = await fetchWithAuth(`${API_URL}/auth/usuario-classroom/${admin.id_persona}`);
      if (respUsuario.ok) {
        const usuario = await respUsuario.json();
        passwordActual = usuario.password_plain || '';
      }
    ...
    if (formValues) {
      ...
      try {
        const responseUsuario = await fetchWithAuth(`${API_URL}/administradores/${idAdmin}/usuario`, {
          method: 'PATCH',
          headers: { 'Content-Type': 'application/json' },
      ...
      if (passwordDashboard && passwordDashboard.length > 0) {
        try {
          const responsePassword = await fetchWithAuth(`${API_URL}/auth/admin-cambiar-password-classroom`, {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
            body: JSON.stringify({ 
...
async function cambiarPasswordAdministrador(id, nombre) {
  ...
  if (password) {
    try {
      const res = await fetchWithAuth(`${API_URL}/administradores/${id}/password`, {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json' },
...
async function eliminarAdministrador(id, nombre) {
  ...
  if (result.isConfirmed) {
    try {
      const res = await fetchWithAuth(`${API_URL}/administradores/${id}`, { method: 'DELETE' });
      const data = await res.json();
...
async function openNuevoCursoModal() {
  try {
    const [idiomasRes, nivelesRes, profesoresRes, aulasRes] = await Promise.all([
      fetchWithAuth(`${API_URL}/idiomas`),
      fetchWithAuth(`${API_URL}/niveles`),
      fetchWithAuth(`${API_URL}/profesores`),
      fetchWithAuth(`${API_URL}/aulas`)
    ]);
    ...
    if (formValues) {
      const res = await fetchWithAuth(`${API_URL}/cursos`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify(formValues)
      });
...
async function editarCurso(id) {
  try {
    const [cursoRes, idiomasRes, nivelesRes, profesoresRes, aulasRes] = await Promise.all([
      fetchWithAuth(`${API_URL}/cursos/${id}`),
      fetchWithAuth(`${API_URL}/idiomas`),
      fetchWithAuth(`${API_URL}/niveles`),
      fetchWithAuth(`${API_URL}/profesores`),
      fetchWithAuth(`${API_URL}/aulas`)
    ...
    if (formValues) {
      const updateRes = await fetchWithAuth(`${API_URL}/cursos/${id}`, {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify(formValues)
      });
...
async function eliminarCurso(id, nombre) {
  ...
  if (result.isConfirmed) {
    try {
      const res = await fetchWithAuth(`${API_URL}/cursos/${id}`, { method: 'DELETE' });
      const data = await res.json();
...
async function asignarProfesorACurso(idCurso, nombreCurso) {
  try {
    ...
    if (idProfesor) {
      const updateRes = await fetchWithAuth(`${API_URL}/cursos/${idCurso}/profesor`, {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json' },
...
async function loadCuotasGestion() {
  ...
  try {
    ...
    cursos.forEach(async (curso) => {
      try {
        const resC = await fetchWithAuth(`${API_URL}/cursos/${curso.id_curso}/cuotas`);
...
async function gestionarCuotasCurso(idCurso, nombreCurso) {
  try {
    const passwordResponse = await fetchWithAuth(`${API_URL}/config/cobranzas-password`);
    ...
    const response = await fetchWithAuth(`${API_URL}/cursos/${idCurso}/cuotas`);
    const data = await response.json();
    ...
    if (result.isConfirmed) {
      ...
      const saveResponse = await fetchWithAuth(`${API_URL}/cursos/${idCurso}/cuotas`, {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json' },
...
async function liberarCuotasTodasLosCursos() {
  ...
  if (result.isConfirmed) {
    ...
    try {
      const response = await fetchWithAuth(`${API_URL}/cursos/cuotas/todos`, {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({ cuotas: cuotasSeleccionadas })
      });
...
async function descargarPDFAlumnos() {
  try {
    ...
    const responseAlumnos = await fetchWithAuth(`${API_URL}/alumnos`);
...
async function descargarPDFProfesores() {
  try {
    ...
    const responseProfesores = await fetchWithAuth(`${API_URL}/profesores`);
    const profesores = await responseProfesores.json();
    
    const responseCursos = await fetchWithAuth(`${API_URL}/cursos`);
...
async function generarComprobantePago(idPago) {
  try {
    ...
    const response = await fetchWithAuth(`${API_URL}/pagos/${idPago}`);
...
async function renderInvestigacionSection() {
  try {
    const [statsRes, encuestasRes] = await Promise.all([
      fetchWithAuth(`${API_URL}/investigacion/estadisticas`),
      fetchWithAuth(`${API_URL}/investigacion/encuestas`)
    ]);
...
async function eliminarEncuesta(id) {
  ...
  if (result.isConfirmed) {
    try {
      const res = await fetchWithAuth(`${API_URL}/investigacion/encuesta/${id}`, {
        method: 'DELETE'
      });
